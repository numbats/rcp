...
- [**Orange-M**]{style="color:blue"}: a file that is already under version control that has been modified. 
- [**Green-U**]{style="color:green"}: a file that is not under version control (yet...). 
...
- [**Purple-R**]{style="color:purple"}: a file that was renamed.
...
You can edit the file using any editor
