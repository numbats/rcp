...
5. Looked at R, Positron and `git`

::: {.fragment}
In the tutorial, you got to know more about R, and some of the available R and Positron resources to help you through the semester.
:::
...
## Handling projects in Positron

In Positron, a project is simply a folder. You can create a new project by creating a new folder, and then opening that folder in Positron.

You can also create projects from templates, or from git repositories.

You can see what project you have open in the top right corner of the interface:

![](images/2026-02-27-14-54-39.png){fig-align="center"}
...
Positron has a less formal idea of a project. It is just a folder that contains all your files, and potentially workspace-specific settings.

To create a new Positron "project", simply create a new folder and open it in Positron.
...
Our main tool is going to be `R` and it's packages. We will be using `R` via Positron.
...
![](images/2026-03-05-08-48-04.png){fig-align="center"}
...
* The [Quarto: Insert Code Cell]{.monash-green2} command in the editor toolbar or
...
Use the "Preview" button at the top

![](images/2026-02-27-15-36-26.png){fig-align="center"}
