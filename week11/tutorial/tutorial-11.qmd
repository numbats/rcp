...
7. `git cherry-pick f87be80 2208c16 ca15ae6`  
...
8. Look in the `renv.lock` file
9. List all branches using `git branch -a`. The three branches of interest are:  
    * `first-r-binary-released`
    * `first-rstudio-release`
    * `first-r-ladies-meetup`
10. Merge these in order, and you are left with some ASCII art that points you to <https://krisanata.github.io/personal-website/hacky-hour>
11. base64 decode the string to find the name of the prophet. Google will give you an answer. The R code gives you number strings which you have to further decode:  
```r
