...
4.	Reproducible reporting using Quarto, Git and GitHub 
5.	Deeper git knowledge, stashing and tools
6.	Reproducible reporting and version control systems
7.	Undoing, exploring, and cleaning with git
8.	Referencing, large files, and GitHub issues
9.	Finding bugs, building pipelines, and presentations
10.	Keeping environments separate and reproducible
...
* [Michael]{.monash-blue}: Tuesdays 11.30-12.30 in person (Building 6 Room 354)
* [Naveen Kaushik]{.monash-blue}: Mondays 12pm-1pm on Zoom

You can post on the discussion forum any time you have any other question.
...
* **3 Assignments:**
  * [**A1**]{.monash-blue}: Released week 1, due week 5: [25%]{.monash-green2}
  * [**A2**]{.monash-blue}: Released week 5, due week 9: [25%]{.monash-green2}
  * [**A3**]{.monash-blue}: Released week 9, due week 12: [25%]{.monash-green2}
* **Mid-semester test:** Based on W1-W7 content: Week 8: [25%]{.monash-green2}

## Mid-semester test

* Conducted in the usual workshop time, but two hours is allocated
* Test will run for 60 minutes
* Closed-book, and invigilated.
...
::: {.aside}
Other IDEs exist, mainly [RStudio](https://posit.co/download/rstudio-desktop/) which is enormously popular, but does not have the same level of integration with `git`.
:::

We don't _need_ an IDE, but it lets us do things more easily.
...
### Positron is the [integrated development environment]{.monash-blue}

![](images/positron_logo.png){width="80%" fig-align="center"}
...
* Overview of Positron and an introduction to R
