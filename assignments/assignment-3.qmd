...
::: {.callout-important}
Join the GitHub Classroom for this assignment [here](https://classroom.github.com/a/DXRNWO7H).
...
Create a maximum 10 slide summary of your group report. The slides must be _fully reproducible_. You should make a new `qmd` in the same repo you've used for Parts A and B. You will record your presentation as a group, and upload this as part of your assignment submission.
...
Please upload the recording for Part C to Moodle.
