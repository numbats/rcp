...
You will be working with a GitHub repository for this assignment. We will use GitHub Classroom, where I have set up some of the structure for you. Please join the classroom [here](https://classroom.github.com/a/dVwQYEj1){target="_blank"}. Make sure to choose your Monash username from the list so we can find your assignment.
...
Create a _subsection_ that will report details about your data. You must include the size of the dataset such as the number of observations, variables and variable types. You must include a sentence that includes _inline R code_ describing the number of variables and observations in your dataset.
